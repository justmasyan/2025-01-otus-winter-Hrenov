...
class TestServiceImplExecuteSimpleUnitTest {
    ...
    void executeTest() {
        ...
        PrintStream inputStream = new PrintStream(outputStreamCaptor);
        ...
        doAnswer(invocation -> {
            ...
            inputStream.printf((String) allArguments[0], argumentsWithoutFirst);
            return null;
        ...
        String actualOutputText = outputStreamCaptor.toString();
        List<String> actualOutputQuestions = exceptedOutputQuestions.stream()
                .filter(actualOutputText::contains)
                .toList();

        assertThat(actualOutputQuestions).isEqualTo(exceptedOutputQuestions);
    }
}
